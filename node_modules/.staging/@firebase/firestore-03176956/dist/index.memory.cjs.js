 ...
 */ var T = /** @class */ function() {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new R(k.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new R(k.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new R(k.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new R(k.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    return t.__extends(n, e), n.prototype.V = function(t, e, r) {
        return new n(t, e, r);
    ...
    n.$ = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new R(k.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
}(V), P = /^[_a-zA-Z][_a-zA-Z0-9]*$/, O = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t.__extends(n, e), n.prototype.V = function(t, e, r) {
    ...
    n.q = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new R(k.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new R(k.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new R(k.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new R(k.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.k = function() {
        return new n([]);
    }, n;
    ...
    if (null === e.K) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            return function(t) {
                ...
                return t.field.N() + t.op.toString() + Vt(t.value);
            }(t);
        })).join(","), n += "|ob:", n += e.orderBy.map((function(t) {
            return (e = t).field.N() + e.dir;
            var e;
        })).join(","), q(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
        n += _n(e.startAt)), e.endAt && (n += "|ub:", n += _n(e.endAt)), e.K = n;
    }
    return e.K;
}
...
function j(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!Tn(t.orderBy[n], e.orderBy[n])) return !1;
...
var W, z, $ = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = L.min()), void 0 === o && (o = L.min()), void 0 === s && (s = B.J), 
 ...
 *     Code.UNKNOWN.
 */ (z = W || (W = {}))[z.OK = 0] = "OK", z[z.CANCELLED = 1] = "CANCELLED", z[z.UNKNOWN = 2] = "UNKNOWN", 
...
var Y = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.P, this.root.st(e, n, this.P).copy(null, null, Z.it, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.P, this.root.remove(e, this.P).copy(null, null, Z.it, null, null));
    }, 
    ...
    t.prototype.ut = function() {
        return new K(this.root, null, this.P, !1);
    }, t.prototype.ct = function(t) {
        return new K(this.root, t, this.P, !1);
    }, t.prototype.lt = function() {
        return new K(this.root, null, this.P, !0);
    }, t.prototype._t = function(t) {
        return new K(this.root, t, this.P, !0);
    }, t;
}(), K = /** @class */ function() {
    function t(t, e, n, r) {
        this.ft = r, this.dt = [];
    ...
    t.prototype.bt = function() {
        if (this.At() && this.left.At()) throw d();
        if (this.right.At()) throw d();
        var t = this.left.bt();
        if (t !== this.right.bt()) throw d();
...
var J = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Dt = function(t) {
        ...
        return new tt(this.data.ut());
    }, t.prototype.ct = function(t) {
        return new tt(this.data.ct(t));
    }, 
 ...
 */ var ft = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.$t = ot(), this.kt = new Y(this.P)
        /**
    ...
    return t.Wt = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.Ut === t.Ut && this.qt.isEqual(t.qt) && sn(this.query, t.query) && this.docs.isEqual(t.docs) && this.Mt.isEqual(t.Mt))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, yt.Ht(e, n)), new t(L.min(), r, ht(), nt(), at());
    }, t;
}(), yt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.Ve = function(t) {
        for (var e = 0, n = t.te; e < n.length; e++) {
            var r = n[e];
            t.ee instanceof Qe ? this.ye(r, t.ee) : t.ee instanceof Xe && this.pe(r, t.key, t.ee);
        }
    ...
    t.prototype.De = function(t) {
        ...
        if (r) {
            ...
            if (G(i)) if (0 === n) {
                ...
                // queries.
                var o = new U(i.path);
                this.pe(e, o, new Xe(o, L.min()));
            } else y(1 === n); else this.Ne(e) !== n && (
    ...
    t.prototype.$e = function(t) {
        ...
        this.Ie.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Yt && G(o.target)) {
                    ...
                    null !== e.Re.get(s) || e.ke(i, s) || e.pe(i, s, new Xe(s, t));
                }
        ...
        var i = new dt(t, n, this.Pe, this.Re, r);
        return this.Re = nt(), this.Ae = _t(), this.Pe = new J(w), i;
    }, 
    /**
    ...
    t.prototype.we = function(t) {
        ...
        var e = this.Ae.get(t);
        return e || (e = new J(w), this.Ae = this.Ae.st(t, e)), e;
    }, 
    /**
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function kt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return b(t.arrayValue.values || [], e.arrayValue.values || [], kt);
...
function Lt(t, e) {
    ...
    var n = St(t), r = St(e), i = w(n.seconds, r.seconds);
...
function Vt(t) {
    return function t(e) {
        ...
        U.B(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function Jt(t, e) {
    ...
    new U((y((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
...
function ee(t) {
    return new S([ "projects", t.s.projectId, "databases", t.s.database ]).N();
}
 ...
 */ function pe(t, e, n) {
    ...
    }(n, e) : t instanceof ge ? me(t, e) : t instanceof we ? be(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = ye(t, e), r = Ee(n) + Ee(t.Ue);
        return qt(n) && qt(t.Ue) ? Wt(r) : zt(t.serializer, r);
    }(t, e);
}
 ...
 */ function de(t, e, n) {
    ...
    // applications.
    return t instanceof ge ? me(t, e) : t instanceof we ? be(t, e) : n;
}
 ...
 */ function ye(t, e) {
    return t instanceof _e ? qt(n = e) || function(t) {
...
/** The result of successfully applying a mutation to the backend. */ var Te = function(
/**
 ...
 */
function Re(t, e) {
    return void 0 !== t.updateTime ? e instanceof Qe && e.version.isEqual(t.updateTime) : void 0 === t.exists || t.exists === e instanceof Qe;
}
 ...
 */ function Le(t, e, n) {
    return t instanceof Ue ? function(t, e, n) {
        // Unlike applySetMutationToLocalView, if we're applying a mutation to a
        // remote document the server has accepted the mutation so the precondition
        // must have held.
        return new Qe(t.key, n.version, t.value, {
        ...
        // known updateTime.
        return new He(t.key, n.version);
        var r = Ce(t, e);
        return new Qe(t.key, n.version, r, {
            hasCommittedMutations: !0
        });
    }(t, e, n) : t instanceof Me ? function(t, e, n) {
        if (y(null != n.transformResults), !Re(t.We, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */
        function(t, e, n) {
            ...
            for (var i = 0; i < n.length; i++) {
                ...
                e instanceof Qe && (u = e.field(o.field)), r.push(de(s, u, n[i]));
            }
            return r;
        }(t.fieldTransforms, e, n.transformResults), o = n.version, s = Fe(t, r.data(), i);
        return new Qe(t.key, o, s, {
            hasCommittedMutations: !0
        });
 ...
 */ function Ve(t, e, n, r) {
    return t instanceof Ue ? function(t, e) {
        if (!Re(t.We, e)) return e;
        var n = Oe(e);
        return new Qe(t.key, n, t.value, {
            Ke: !0
        });
    }(t, e) : t instanceof qe ? function(t, e) {
        if (!Re(t.We, e)) return e;
        var n = Oe(e), r = Ce(t, e);
        return new Qe(t.key, n, r, {
            Ke: !0
        });
    }(t, e) : t instanceof Me ? function(t, e, n, r) {
        if (!Re(t.We, e)) return e;
        var i = xe(t, e), o = function(t, e, n, r) {
            for (var i = [], o = 0, s = t; o < s.length; o++) {
                var u = s[o], a = u.transform, c = null;
                n instanceof Qe && (c = n.field(u.field)), null === c && r instanceof Qe && (
                // If the current document does not contain a value for the mutated
                // field, use the value that existed before applying this mutation
                // batch. This solves an edge case where a PatchMutation clears the
                // values in a nested map before the TransformMutation is applied.
                c = r.field(u.field)), i.push(pe(a, c, e));
            }
            return i;
        }(t.fieldTransforms, n, e, r), s = Fe(t, i.data(), o);
        return new Qe(t.key, i.version, s, {
            Ke: !0
        });
    }(t, e, r, n) : function(t, e) {
        return Re(t.We, e) ? new Xe(t.key, L.min()) : e;
    }(t, e);
}
 ...
 */ function Se(t, e) {
    return t instanceof Me ? function(t, e) {
        for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
            var o = i[r], s = e instanceof Qe ? e.field(o.field) : void 0, u = ye(o.transform, s || null);
            null != u && (n = null == n ? (new We).set(o.field, u) : n.set(o.field, u));
        }
        return n ? n.ze() : null;
    }(t, e) : null;
}
...
function Pe(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.We.isEqual(e.We) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || b(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof ge && e instanceof ge || t instanceof we && e instanceof we ? b(t.elements, e.elements, kt) : t instanceof _e && e instanceof _e ? kt(t.Ue, e.Ue) : t instanceof ve && e instanceof ve;
 ...
 */ function Oe(t) {
    return t instanceof Qe ? t.version : L.min();
}
...
function Ce(t, e) {
    ...
    }(t, e instanceof Qe ? e.data() : Be.empty());
}
...
function Fe(t, e, n) {
    for (var r = new We(e), i = 0; i < t.fieldTransforms.length; i++) {
...
/** A mutation that deletes the document at the given key. */ var je = /** @class */ function(e) {
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.ze = function() {
        ...
        return null != t ? new Be(t) : this.He;
    }, 
    /**
    ...
    t.prototype.Xe = function(t, e) {
        var n = this, r = !1, i = this.He.field(t), o = Ft(i) ? // If there is already data at the current path, base our
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    if (!(t instanceof e)) throw e.name === t.constructor.name ? new R(k.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass '" + e.name + "' from a different Firestore SDK?") : new R(k.INVALID_ARGUMENT, "Expected type '" + e.name + "', but was '" + t.constructor.name + "'");
    return t;
}
...
/** Creates a new Query for a query that matches all documents at `path` */ function Ze(t) {
    return new Ke(t);
}
 ...
 */ function tn(t) {
    ...
    if (null === e.sn) {
        ...
        n.L() || e.sn.push(new Nn(n)), e.sn.push(new Nn(O.M(), "asc" /* ASCENDING */)); else {
 ...
 */ function en(t) {
    var e = Ye(t, Ke);
    if (!e.rn) if ("F" /* First */ === e.nn) e.rn = x(e.path, e.collectionGroup, tn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = tn(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Nn(o.field, s));
        }
        ...
        // Now return as a LimitType.First query.
                e.rn = x(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.rn;
}

function nn(t, e, n) {
    return new Ke(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
}

function rn(t, e) {
    return new Ke(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), t.limit, t.nn, e, t.endAt);
}

function on(t, e) {
    return new Ke(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), t.limit, t.nn, t.startAt, e);
}

function sn(t, e) {
    return j(en(t), en(e)) && t.nn === e.nn;
}
...
function an(t) {
    return "Query(target=" + function(t) {
        ...
        t.filters.length > 0 && (e += ", filters: [" + t.filters.map((function(t) {
            return (e = t).field.N() + " " + e.op + " " + Vt(e.value);
        ...
        q(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.N() + " (" + e.dir + ")";
            var e;
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + _n(t.startAt)), t.endAt && (e += ", endAt: " + _n(t.endAt)), 
        "Target(" + e + ")";
    }(en(t)) + "; limitType=" + t.nn + ")";
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function cn(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.W(t.collectionGroup) && t.path.C(n) : U.j(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
        ...
        return !(t.startAt && !En(t.startAt, tn(t), e)) && (!t.endAt || !En(t.endAt, tn(t), e));
    }(t, e);
}
...
var fn = /** @class */ function(e) {
     ...
     */    return t.__extends(n, e), n.create = function(t, e, r) {
        if (t.L()) return "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.dn(t, e, r) : new ln(t, e, r);
        if (Mt(r)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new R(k.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (xt(r)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new R(k.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new vn(t, r) : "in" /* IN */ === e ? new gn(t, r) : "not-in" /* NOT_IN */ === e ? new mn(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new wn(t, r) : new n(t, e, r);
    }, n.dn = function(t, e, n) {
        return "in" /* IN */ === e ? new pn(t, n) : new dn(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.wn(Dt(e, this.value)) : null !== e && Tt(this.value) === Tt(e) && this.wn(Dt(e, this.value));
...
var ln = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = U.B(r.referenceValue), i;
    }
    return t.__extends(n, e), n.prototype.matches = function(t) {
        var e = U.P(t.key, this.key);
        return this.wn(e);
    }, n;
}(fn), pn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
/** Filter that matches on key fields within an array. */ function yn(t, e) {
    ...
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((function(t) {
        return U.B(t.referenceValue);
    }));
}

/** A Filter that implements the array-contains operator. */ var vn = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return t.__extends(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return Ct(e) && Rt(e.arrayValue, this.value);
    }, n;
...
/** A Filter that implements the IN operator. */ function _n(t) {
 ...
 */ function En(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.L() ? U.P(U.B(s.referenceValue), n.key) : Dt(s, n.field(o.field)), 
 ...
 */ var Nn = function(t, e /* ASCENDING */) {
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

function An(t, e, n) {
    var r = t.field.L() ? U.P(e.key, n.key) : function(t, e, n) {
        var r = e.field(t), i = n.field(t);
        return null !== r && null !== i ? Dt(r, i) : d();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var kn = /** @class */ function() {
    ...
    t.prototype.In = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = Ve(i, e, e, this.mn));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = Ve(a, e, o, this.mn));
        }
        return e;
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = st, o = e.mutations, s = 0; s < o.length; s++) i = i.st(o[s].key, r[s].version);
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.gn && d(), this.gn = !0, this.pn ? this.error ? this.vn(n, this.error) : this.bn(e, this.result) : new t((function(t, i) {
            r.Vn = function(n) {
                r.bn(e, n).next(t, i);
            }, r.yn = function(e) {
                r.vn(n, e).next(t, i);
    ...
    t.prototype.Bn = function(t, e) {
        ...
        return this.$n.Wn(t, e).next((function(r) {
            var i = n.qn(t, e, r), o = nt();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new Xe(t, L.min())), o = o.st(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
        ...
        return this.On(t, new U(e)).next((function(t) {
            var e = ot();
            return t instanceof Qe && (e = e.st(t.key, t)), e;
        }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Yn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], c = a.key, h = r.get(c), f = Ve(a, h, h, o.mn);
                    r = f instanceof Qe ? r.st(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        return this.Nn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof Qe && (c = c.st(t, e));
            })), c;
        }));
    }, t;
}(), Vn = /** @class */ function() {
...
/** The result of applying a mutation batch to the backend. */ Sn.rs = -1;
...
var Pn = function() {
    ...
    t.prototype.ws = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && h("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.ls + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
 ...
 */ var Cn = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Rs = t, this.hs = e, this.As = n, this.op = r, this.Ps = i, this.Vs = new Pn, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.ps && (this.clearTimeout(), this.Vs.reject(new R(k.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function e() {
        ...
        this.ks = new On(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Os = function() {
            var e = qn();
            e && h("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.ks.Es();
        };
        var e = qn();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.Os);
    }
    return Object.defineProperty(e.prototype, "xs", {
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Ss[0]() ];

                  case 2:
                    return t.sent(), this.Ss.shift(), this.ks.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!Un(e = t.sent())) throw e;
 ...
 */
     ...
     */
    e.prototype.Ts = function(t, e, n) {
        var r = this;
        this.Ms(), 
        // Fast-forward delays for timerIds that have been overriden.
        this.$s.indexOf(t) > -1 && (e = 0);
        var i = Cn.ys(this, t, e, n, (function(t) {
            return r.Qs(t);
        }));
    ...
    e.prototype.Gs = function() {
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return [ 4 /*yield*/ , e = this.bs ];

                  case 1:
                    t.sent(), t.label = 2;

                  case 2:
                    if (e !== this.bs) return [ 3 /*break*/ , 0 ];
                    t.label = 3;
    ...
    /** Called once a DelayedOperation is run or canceled. */ e.prototype.Qs = function(t) {
 ...
 */
function xn(t, e) {
    if (f("AsyncQueue", e + ": " + t), Un(t)) return new R(k.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
Fn.ni = -1, Fn.si = 1048576, Fn.ii = 41943040, Fn.ti = 10, Fn.ei = 1e3, Fn.ri = new Fn(Fn.ii, Fn.ti, Fn.ei), 
Fn.oi = new Fn(Fn.ni, 0, 0);
...
var jn = /** @class */ function() {
    ...
    return t.prototype.ai = function(t, e) {
        return this.hi.add(e), Dn.resolve();
    }, t.prototype.zn = function(t, e) {
        return Dn.resolve(this.hi.getEntries(e));
    }, t;
}(), Gn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.S(), n = t.g(), r = this.index[e] || new J(S.P), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.S(), n = t.g(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new J(S.P)).F();
    }, t;
}(), Bn = /** @class */ function() {
    function t(t) {
        this.ui = t;
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.wi = L.min(), this.$n = t.mi(n), this.Ti = t.Ei(), this.Ii = t.Ri(), this.Ai = new Ln(this.Ti, this.$n, this.persistence.Pi()), 
        this._i.Vi(this.Ai);
    }
...
function zn(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = Dn.resolve();
            return o.forEach((function(t) {
                s = s.next((function() {
                    return r.Mn(e, t);
                })).next((function(e) {
                    var o = e, s = n.Pn.get(t);
                    y(null !== s), (!o || o.version.o(s) < 0) && ((o = i.Tn(t, o, n)) && 
     ...
     */
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Gt.forEach((function(a, c) {
                ...
                // cache.
                                c instanceof Xe && c.version.isEqual(L.min()) ? (
                // NoDocuments with SnapshotVersion.min() are used in manufactured
                // events. We remove these documents from cache since we lost
                // access.
                o.Oi(a, r), u = u.st(a, c)) : null == f || c.version.o(f.version) > 0 || 0 === c.version.o(f.version) && f.hasPendingWrites ? (o.bi(c, r), 
...
function Hn(e, n, r) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                i = v(e), o = i.fi.get(n), s = r ? "readwrite" : "readwrite-primary", t.label = 1;
 ...
 */ function Yn(t, e, n) {
     ...
     */
        ...
        return function(t, e, n) {
            var r = v(t), i = r.di.get(n);
            return void 0 !== i ? Dn.resolve(r.fi.get(i)) : r.Ii.Ui(e, n);
        }(r, t, en(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Ii.Bi(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r._i.Qn(t, e, n ? i : L.min(), n ? o : at());
        })).next((function(t) {
            return {
                documents: t,
                Wi: o
...
function Kn(e) {
    return t.__awaiter(this, void 0, void 0, (function() {
        return t.__generator(this, (function(t) {
            if (e.code !== k.FAILED_PRECONDITION || "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab." !== e.message) throw e;
 ...
 */ var Zn = /** @class */ function() {
    ...
    t.prototype.Zi = function(t) {
        var e = this, n = new U(new S([])), r = new Jn(n, t), i = new Jn(n, t + 1), o = [];
        ...
        var e = new U(new S([])), n = new Jn(e, t), r = new Jn(e, t + 1), i = at();
    ...
    return t.ji = function(t, e) {
        return U.P(t.key, e.key) || w(t.sr, e.sr);
    }, 
    /** Compare by ID then by key */ t.Ki = function(t, e) {
        return w(t.sr, e.sr) || U.P(t.key, e.key);
    }, t;
}(), tr = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
tr.or = new tr("google-credentials-uid"), tr.hr = new tr("first-party-uid");
...
var er = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = tr.UNAUTHENTICATED, this.wr = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.mr !== e ? (h("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (y("string" == typeof n.accessToken), new er(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.Tr = function() {
        ...
        return y(null === t || "string" == typeof t), new tr(t);
    }, t;
}(), ir = /** @class */ function() {
    function t(t, e) {
        this.Er = t, this.Ir = e, this.type = "FirstParty", this.user = tr.hr;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new ir(this.Er, this.Ir));
    }, t.prototype.lr = function(t) {
    ...
    function e(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.yr = 0, this.pr = null, this.stream = null, this.ks = new On(t, e)
        /**
    ...
    return e.prototype.gr = function() {
    ...
    /** Sends a message to the underlying stream. */ e.prototype.Fr = function(t) {
        this.Nr(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ e.prototype.Dr = function() {
        return t.__awaiter(this, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
    ...
    /** Marks the stream as active again. */ e.prototype.Nr = function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    this.state = e, [ 4 /*yield*/ , this.listener.kr(n) ];
     ...
     */
    e.prototype.$r = function() {}, e.prototype.auth = function() {
        var t = this;
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new R(k.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.Lr(e);
            }));
        }));
    }, e.prototype.xr = function(t) {
    ...
    e.prototype.Or = function(t) {
        ...
        return function(n) {
            e.os.vs((function() {
                return e.yr === t ? n() : (h("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, e;
    ...
    return t.__extends(n, e), n.prototype.Mr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Me ? (y(void 0 === e || "string" == typeof e), B.fromBase64String(e || "")) : (y(void 0 === e || e instanceof Uint8Array), 
                    B.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? k.UNKNOWN : H(t.code);
                ...
                var c = Jt(t, a.document.name), h = Yt(a.document.updateTime), f = new Be({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = new Qe(c, h, f, {}), p = a.targetIds || [], v = a.removedTargetIds || [];
                n = new vt(p, v, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var g = e.documentDelete;
                g.document;
                var m = Jt(t, g.document), w = g.readTime ? Yt(g.readTime) : L.min(), b = new Xe(m, w), _ = g.removedTargetIds || [];
                n = new vt([], _, b.key, b);
                ...
                var A = e.filter;
                A.targetId;
                var T = A.count || 0, D = new Q(T), V = A.targetId;
                n = new gt(V, D);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? L.min() : e.readTime ? Yt(e.readTime) : L.min();
        }(t);
    ...
    n.prototype.Wr = function(t) {
        ...
        e.database = ee(this.serializer), e.addTarget = function(t, e) {
            ...
            return (n = G(r) ? {
                ...
                query: oe(t, r)
            }).targetId = e.targetId, e.resumeToken.Y() > 0 && (n.resumeToken = Xt(t, e.resumeToken)), 
            n;
        }(this.serializer, t);
        var n = function(t, e) {
            var n = function(t, e) {
    ...
    n.prototype.Qr = function(t) {
        var e = {};
        e.database = ee(this.serializer), e.removeTarget = t, this.Fr(e);
    }, n;
    ...
    return t.__extends(n, e), Object.defineProperty(n.prototype, "Gr", {
        /**
    ...
    n.prototype.start = function() {
        ...
        y(!!t.streamToken), this.lastStreamToken = t.streamToken, this.jr) {
        ...
        // The first response is always the handshake response
                return y(!t.writeResults || 0 === t.writeResults.length), this.jr = !0, 
        this.listener.Hr();
    }, 
    /**
    ...
    n.prototype.Yr = function() {
        ...
        var t = {};
        t.database = ee(this.serializer), this.Fr(t);
    }, 
    ...
    return t.__extends(n, e), n.prototype.Xr = function() {
        if (this.Jr) throw new R(k.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Zr = function(t, e, n) {
        ...
        return this.Xr(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === k.UNAUTHENTICATED && r.credentials.cr(), t;
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.io ? (f(e), this.io = !1) : h("OnlineStateTracker", e);
    ...
    n, r, i, o) {
        ...
        /**
             ...
             */
        this.wo = new Set, this.mo = o, this.mo.To((function(e) {
            r.vs((function() {
                return t.__awaiter(s, void 0, void 0, (function() {
                    return t.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.Eo() ? (h("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.Ao = function(t, e, n) {
            var r = v(t);
            return r.Xr(), new ur(e, r.Pr, r.credentials, r.serializer, n);
        }(this.lo, r, {
            ...
            var r = v(t);
            return r.Xr(), new ar(e, r.Pr, r.credentials, r.serializer, n);
        }(this.lo, r, {
    ...
    e.prototype.disableNetwork = function() {
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this._o.length > 0 && (h("RemoteStore", "Stopping write stream with " + this._o.length + " pending writes"), 
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return h("RemoteStore", "RemoteStore shutting down."), this.wo.add(5 /* Shutdown */), 
                    [ 4 /*yield*/ , this.$o() ];
    ...
    /** {@link TargetMetadataProvider.getTargetDataForTarget} */ e.prototype.Le = function(t) {
        return this.fo.get(t) || null;
    }, 
    /** {@link TargetMetadataProvider.getRemoteKeysForTarget} */ e.prototype.xe = function(t) {
        return this.qo.xe(t);
    }, 
    /**
    ...
    e.prototype.Do = function() {
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            var e = this;
            return t.__generator(this, (function(t) {
                return this.fo.forEach((function(t, n) {
                    e.xo(t);
                })), [ 2 /*return*/ ];
            }));
        }));
    }, e.prototype.Vo = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
                return this.ko(), 
                // If we still need the watch stream, retry the connection.
                this.Do() ? (this.Ro.ao(e), this.Fo()) : 
    ...
    }, e.prototype.yo = function(e, n) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var r, i, o;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    if (this.Ro.set("Online" /* Online */), !(e instanceof mt && 2 /* Removed */ === e.state && e.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    t.label = 1;

                  case 1:
                    return t.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this.Uo(e) ];
                  ...
                  case 6:
                    if (e instanceof vt ? this.do.Ve(e) : e instanceof gt ? this.do.De(e) : this.do.ge(e), 
                    n.isEqual(L.min())) return [ 3 /*break*/ , 13 ];
                    t.label = 7;

                  case 7:
                    return t.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , $n(this.co) ];

                  case 8:
                    return i = t.sent(), n.o(i) >= 0 ? [ 4 /*yield*/ , this.Wo(n) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return h("RemoteStore", "Failed to raise snapshot:", o = t.sent()), [ 4 /*yield*/ , this.Bo(o) ];
    ...
    /** Handles an error on a target */ e.prototype.Uo = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n, r, i, o;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    t.sent(), this.fo.delete(o), this.do.removeTarget(o), t.label = 3;
    ...
    e.prototype.No = function() {
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    e = this._o.length > 0 ? this._o[this._o.length - 1].batchId : -1, t.label = 1;
                  ...
                  case 2:
                    return t.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , Xn(this.co, e) ];

                  case 3:
                    return null === (n = t.sent()) ? (0 === this._o.length && this.po.Cr(), [ 3 /*break*/ , 7 ]) : (e = n.batchId, 
                    this.zo(n), [ 3 /*break*/ , 6 ]);

                  case 4:
                    return r = t.sent(), [ 4 /*yield*/ , this.Bo(r) ];
    ...
    e.prototype.zo = function(t) {
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                ...
                for (e = 0, n = this._o; e < n.length; e++) r = n[e], this.po.Kr(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
    }, e.prototype.zr = function(e, n) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var r, i, o = this;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return r = this._o.shift(), i = Rn.from(r, e, n), [ 4 /*yield*/ , this.Qo((function() {
                        return o.qo.Xo(i);
                    })) ];
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return e && this.po.Gr ? [ 4 /*yield*/ , this.Zo(e) ] : [ 3 /*break*/ , 2 ];
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return X(r = e.code) && r !== k.ABORTED ? (n = this._o.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.po.Sr(), [ 4 /*yield*/ , this.Qo((function() {
                        return i.qo.th(n.batchId, e);
                    })) ]) : [ 3 /*break*/ , 3 ];
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    h("RemoteStore", "RemoteStore received new credentials"), this.wo.add(3 /* CredentialChange */), 
                    [ 4 /*yield*/ , this.$o() ];

                  case 1:
                    return t.sent(), this.Ro.set("Unknown" /* Unknown */), [ 4 /*yield*/ , this.qo.eh(e) ];

                  case 2:
                    return t.sent(), this.wo.delete(3 /* CredentialChange */), [ 4 /*yield*/ , this.Co() ];
     ...
     */
    e.prototype.nh = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return e ? (this.wo.delete(2 /* IsSecondary */), [ 4 /*yield*/ , this.Co() ]) : [ 3 /*break*/ , 2 ];

                  case 1:
                    return t.sent(), [ 3 /*break*/ , 5 ];

                  case 2:
                    return (n = e) ? [ 3 /*break*/ , 4 ] : (this.wo.add(2 /* IsSecondary */), [ 4 /*yield*/ , this.$o() ]);

                  case 3:
                    t.sent(), n = this.Ro.set("Unknown" /* Unknown */), t.label = 4;
    ...
    function t() {
        this.oh = new lr, this.hh = {}, this.eo = null, this.ts = null;
    }
    return t.prototype.ah = function(t) {
        ...
        return this.oh = new lr, Promise.resolve();
    ...
    e) {
        ...
        this.qt = at(), this.Vh = hn(t), this.yh = new ft(this.Vh);
    }
    ...
    t.prototype.gh = function(t, e) {
        var n = this, r = e ? e.vh : new lt, i = e ? e.yh : this.yh, o = e ? e.qt : this.qt, s = i, u = !1, a = this.query.an() && i.size === this.query.limit ? i.last() : null, c = this.query.un() && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.ht((function(t, e) {
            var h = i.get(t), f = e instanceof Qe ? e : null;
    ...
    t.prototype.Ch = function(t, e, n) {
        ...
        return this.Ah = u, 0 !== o.length || a ? {
            snapshot: new pt(this.query, t.yh, i, o, t.qt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Nh: s
        } : {
            Nh: s
    ...
    t.prototype.Dh = function(t) {
        ...
        // updating many documents.
                var e = this.Ph;
        this.Ph = at(), this.yh.forEach((function(e) {
            t.kh(e.key) && (t.Ph = t.Ph.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Ph.has(e) || n.push(new yr(e));
    ...
    t.prototype.xh = function() {
        return pt.Wt(this.query, this.yh, this.qt, 0 /* Local */ === this.Ah);
    }, t;
}(), gr = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.Bh = null, this.Wh = new T((function(t) {
            return un(t);
        }), sn), this.Qh = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Kh = new Map, this.zh = new Zn, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Hh = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Yh = new Map, this.Jh = Bn.li(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return Object.defineProperty(e.prototype, "Zh", {
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.ta("listen()"), (i = this.Wh.get(e)) ? (
             ...
             */
                    function(t, e) {
                        ...
                        return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
                            ...
                            return n.Ii.Ui(t, e).next((function(i) {
                                ...
                                r = i, Dn.resolve(r)) : n.Ii.ea(t).next((function(i) {
                  ...
                  case 2:
                    return o = t.sent(), s = this.qh.lh(o.targetId), n = o.targetId, [ 4 /*yield*/ , this.sa(e, n, "current" === s) ];

                  case 3:
                    r = t.sent(), this.Zh && this.Mh.listen(o), t.label = 4;
     ...
     * snapshot.
     */
    e.prototype.sa = function(e, n, r) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var i, o, s, u, a, c;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return [ 4 /*yield*/ , Yn(this.co, e, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return i = t.sent(), o = new vr(e, i.Wi), s = o.gh(i.documents), u = yt.Ht(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Ch(s, 
                    /* updateLimboDocuments= */ this.Zh, u), this.ia(n, a.Nh), c = new gr(e, n, o), 
                    [ 2 /*return*/ , (this.Wh.set(e, c), this.Qh.has(n) ? this.Qh.get(n).push(e) : this.Qh.set(n, [ e ]), 
                    a.snapshot) ];
                }
            }));
        }));
    }, e.prototype.Lo = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n, r, i = this;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.ta("unlisten()"), n = this.Wh.get(e), (r = this.Qh.get(n.targetId)).length > 1 ? [ 2 /*return*/ , (this.Qh.set(n.targetId, r.filter((function(t) {
                        return !sn(t, e);
                    }))), void this.Wh.delete(e)) ] : this.Zh ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.qh.fh(n.targetId), this.qh.Th(n.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Hn(this.co, n.targetId, 
                  ...
                  case 3:
                    return this.ra(n.targetId), [ 4 /*yield*/ , Hn(this.co, n.targetId, 
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    this.ta("write()"), t.label = 1;

                  case 1:
                    return t.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , 
                    /* Accepts locally generated Mutations and commit them to storage. */
                    function(t, e) {
                        var n, r = v(t), i = D.now(), o = e.reduce((function(t, e) {
                            return t.add(e.key);
                        }), at());
                        return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                            return r.Ai.Un(t, o).next((function(o) {
                                ...
                                var s = [], u = 0, a = e; u < a.length; u++) {
                                    ...
                                    // exists=true
                                    s.push(new qe(c.key, h, ze(h.proto.mapValue), ke.exists(!0)));
                                }
                  ...
                  case 2:
                    return r = t.sent(), this.qh.ah(r.batchId), this.aa(r.batchId, n), [ 4 /*yield*/ , this.ua(r.ha) ];

                  case 3:
                    return t.sent(), [ 4 /*yield*/ , this.Mh.No() ];

                  case 4:
                    return t.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = t.sent(), o = xn(i, "Failed to persist write"), n.reject(o), [ 3 /*break*/ , 6 ];
    ...
    }, e.prototype.jo = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n, r = this;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    this.ta("applyRemoteEvent()"), t.label = 1;

                  case 1:
                    return t.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Qn(this.co, e) ];

                  case 2:
                    return n = t.sent(), 
                    // Update `receivedDocument` as appropriate for any limbo targets.
                    e.Qt.forEach((function(t, e) {
                        var n = r.Kh.get(e);
                        n && (
                        // Since this is a limbo resolution lookup, it's for a single document
                        // and it could be added, modified, or removed, but not a combination.
                        y(t.Jt.size + t.Xt.size + t.Zt.size <= 1), t.Jt.size > 0 ? n.Lh = !0 : t.Xt.size > 0 ? y(n.Lh) : t.Zt.size > 0 && (y(n.Lh), 
                        n.Lh = !1));
                    })), [ 4 /*yield*/ , this.ua(n, e) ];
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.qh._h(e, "rejected", n), r = this.Kh.get(e), (i = r && r.key) ? (o = (o = new Y(U.P)).st(i, new Xe(i, L.min())), 
                    s = at().add(i), u = new dt(L.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new J(w), o, s), [ 4 /*yield*/ , this.jo(u) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 1:
                    ...
                    this.Gh = this.Gh.remove(i), this.Kh.delete(e), this.la(), [ 3 /*break*/ , 4 ];

                  case 2:
                    return [ 4 /*yield*/ , Hn(this.co, e, 
                    /* keepPersistedTargetData */ !1).then((function() {
                        return a.ra(e, n);
                    })).catch(Kn) ];
    ...
    }, e.prototype.Xo = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n, r;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    this.ta("applySuccessfulWrite()"), n = e.batch.batchId, t.label = 1;

                  case 1:
                    return t.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , zn(this.co, e) ];
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    this.ta("rejectFailedWrite()"), t.label = 1;
                    ...
                    return t.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                        ...
                        return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                            ...
                            return n.$n.da(t, e).next((function(e) {
                                return y(null !== e), r = e.keys(), n.$n.Si(t, e);
                            })).next((function() {
                                return n.$n.Ci(t);
                            })).next((function() {
                                return n.Ai.Un(t, r);
                  ...
                  case 2:
                    ...
                    // listen events.
                    this._a(e, n), this.fa(e), this.qh.uh(e, "rejected", n), [ 4 /*yield*/ , this.ua(r) ];
    ...
    }, e.prototype.wa = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n, r, i, o;
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    this.Mh.Eo() || h("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    t.label = 1;
                  ...
                  case 2:
                    return -1 === (n = t.sent()) ? [ 2 /*return*/ , void e.resolve() ] : ((r = this.Yh.get(n) || []).push(e), 
                    this.Yh.set(n, r), [ 3 /*break*/ , 4 ]);

                  case 3:
                    return i = t.sent(), o = xn(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ e.prototype.Ta = function(t) {
        this.Yh.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new R(k.CANCELLED, t));
            }));
        })), this.Yh.clear();
    }, e.prototype.aa = function(t, e) {
        var n = this.Hh[this.currentUser.rr()];
        n || (n = new Y(w)), n = n.st(t, e), this.Hh[this.currentUser.rr()] = n;
    }, 
    /**
     * Resolves or rejects the user callback for the given batch and then discards
     * it.
     */
    e.prototype._a = function(t, e) {
        var n = this.Hh[this.currentUser.rr()];
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof dr ? (this.zh.zi(i.key, t), this.Ra(i)) : i instanceof yr ? (h("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.Gh.get(e) || (h("SyncEngine", "New document in limbo: " + e), this.jh.push(e), 
        this.la());
    }, 
    /**
    ...
    e.prototype.la = function() {
        for (;this.jh.length > 0 && this.Gh.size < this.Uh; ) {
            ...
            this.Kh.set(e, new mr(t)), this.Gh = this.Gh.st(t, e), this.Mh.listen(new $(en(Ze(t.path)), e, 2 /* LimboResolution */ , Sn.rs));
        }
    }, 
    // Visible for testing
    ...
    e.prototype.Pa = function() {
        return this.jh;
    }, e.prototype.ua = function(e, n) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var r, i, o, s = this;
            return t.__generator(this, (function(u) {
                switch (u.label) {
                  case 0:
                    return r = [], i = [], o = [], this.Wh.forEach((function(t, u) {
                        o.push(Promise.resolve().then((function() {
                            var t = u.view.gh(e);
                            return t.Sh ? Yn(s.co, u.query, 
                            /* usePreviousResults= */ !1).then((function(e) {
                                var n = e.documents;
                                return u.view.gh(n, t);
                            })) : t;
                            ...
                            if (s.ia(u.targetId, o.Nh), o.snapshot) {
                                ...
                                var a = Vn.Zn(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return u.sent(), this.Bh.Br(r), [ 4 /*yield*/ , function(e, n) {
                        return t.__awaiter(this, void 0, void 0, (function() {
                                ...
                                switch (t.label) {
                                  ...
                                  case 1:
                                    return t.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , r.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                        return Dn.forEach(n, (function(e) {
                                            return Dn.forEach(e.Jn, (function(n) {
                                                return r.persistence.Li.zi(t, e.targetId, n);
                                            })).next((function() {
                                                return Dn.forEach(e.Xn, (function(n) {
                                  ...
                                  case 4:
                                    for (o = 0, s = n; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (c = r.fi.get(a), 
                                    f = c.Z, l = c.nt(f), 
    ...
    }, e.prototype.ta = function(t) {}, e.prototype.eh = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n;
            return t.__generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return this.currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (h("SyncEngine", "User change. New user:", e.rr()), 
                    [ 4 /*yield*/ , 
                    /**
                 ...
                 */
                    ...
                    function(e, n) {
                        return t.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return t.__generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return r = v(e), i = r.$n, o = r.Ai, [ 4 /*yield*/ , r.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                                        ...
                                        return r.$n.Va(t).next((function(s) {
                                            ...
                                            // MutationQueue.
                                            o = new Ln(r.Ti, i, r.persistence.Pi()), i.Va(t);
                                        })).next((function(n) {
                                            for (var r = [], i = [], s = at(), u = 0, a = e
                                  ...
                                  case 1:
                                    return s = t.sent(), [ 2 /*return*/ , (r.$n = i, r.Ai = o, r._i.Vi(r.Ai), s) ];
                                }
                            }));
                        }));
                    }(this.co, e) ]);
                  ...
                  case 1:
                    ...
                    this.qh.Eh(e, n.pa, n.ga), [ 4 /*yield*/ , this.ua(n.ya) ];
        ...
        var e = this.Kh.get(t);
        if (e && e.Lh) return at().add(e.key);
        var n = at(), r = this.Qh.get(t);
        if (!r) return n;
    ...
    function e(t) {
        this.qo = t, this.ba = new T((function(t) {
            return un(t);
        }), sn), this.onlineState = "Unknown" /* Unknown */ , this.Sa = new Set, this.qo.subscribe(this);
    }
    return e.prototype.listen = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    if (n = e.query, r = !1, (i = this.ba.get(n)) || (r = !0, i = new br), !r) return [ 3 /*break*/ , 4 ];
                    t.label = 1;

                  case 1:
                    return t.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.qo.listen(n) ];

                  case 2:
                    return o.va = t.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = t.sent(), u = xn(s, "Initialization of query '" + an(e.query) + "' failed"), 
                    [ 2 /*return*/ , void e.onError(u) ];

                  case 4:
                    return this.ba.set(n, i), i.listeners.push(e), 
                    // Run global snapshot listeners if a consistent snapshot has been emitted.
                    e.$h(this.onlineState), i.va && e.Ca(i.va) && this.Da(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, e.prototype.Lo = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n, r, i, o;
            return t.__generator(this, (function(t) {
                return n = e.query, r = !1, (i = this.ba.get(n)) && (o = i.listeners.indexOf(e)) >= 0 && (i.listeners.splice(o, 1), 
    ...
    return t.prototype.Ca = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new pt(t.query, t.docs, t.Mt, e, t.qt, t.fromCache, t.Ut, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.$h = function(t) {
        ...
        t = pt.Wt(t.query, t.docs, t.qt, t.fromCache), this.ka = !0, this.$a.next(t);
    }, t;
}(), Ir = /** @class */ function() {
    function t() {}
    return t.prototype.Vi = function(t) {
        this.Ua = t;
    }, t.prototype.Qn = function(t, e, r, i) {
        var o = this;
        // Queries that match all documents don't benefit from using
        // IndexFreeQueries. It is more efficient to scan all documents in a
        // collection, rather than to perform individual lookups.
                return e.hn() || r.isEqual(L.min()) ? this.Ba(t, e) : this.Ua.Un(t, i).next((function(s) {
            var u = o.Wa(e, s);
            return (e.an() || e.un()) && o.Sh(e.nn, u, i, r) ? o.Ba(t, e) : (c() <= n.LogLevel.DEBUG && h("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), an(e)), 
            o.Ua.Qn(t, e, r).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.Wa = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof Qe && cn(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
    ...
    t.prototype.Sh = function(t, e, n, r) {
        ...
        return c() <= n.LogLevel.DEBUG && h("IndexFreeQueryEngine", "Using full collection scan to execute query:", an(e)), 
    ...
    return t.prototype.Ga = function(t) {
        return Dn.resolve(0 === this.$n.length);
        ...
        return Dn.resolve(this.Ka(e));
    }, t.prototype.qi = function(t, e) {
        var n = e + 1, r = this.za(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Dn.resolve(this.$n.length > i ? this.$n[i] : null);
    }, t.prototype.ma = function() {
        return Dn.resolve(0 === this.$n.length ? -1 : this.Qa - 1);
    }, t.prototype.Va = function(t) {
        return Dn.resolve(this.$n.slice());
        ...
        // because it precedes all other segments in an ordered traversal.
                U.j(i) || (i = i.child(""));
        var o = new Jn(new U(i), 0), s = new J(w);
        ...
        var n = this;
        y(0 === this.Ya(e.batchId, "removed")), this.$n.shift();
        var r = this.ja;
        ...
        return this.$n.length, Dn.resolve();
    }, 
    /**
    ...
    t.prototype.Oi = function(t) {
        ...
        for (var r = ot(), i = new U(e.path.child("")), o = this.docs.ct(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.Tt(); ) {
            var s = o.wt(), u = s.key, a = s.value, c = a.tu, h = a.readTime;
            if (!e.path.C(u.path)) break;
            h.o(n) <= 0 || c instanceof Qe && cn(e, c) && (r = r.st(c.key, c));
        }
        return Dn.resolve(r);
 ...
 */
Ar.nu = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).uu = t, n;
    }
    return t.__extends(n, e), n.prototype.Ch = function(t) {
        var e = this, n = [];
    ...
    t.prototype.Mn = function(t, e) {
        this.ou();
        var n = this.ha.get(e);
        return void 0 !== n ? Dn.resolve(n) : this.hu(t, e);
    }, 
    /**
...
var Tr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this._u = new Zn, this.targetCount = 0, this.fu = Bn.ci();
    }
    return t.prototype.ve = function(t, e) {
        ...
        return Dn.resolve(this.lu);
    }, t.prototype.ea = function(t) {
        return this.highestTargetId = this.fu.next(), Dn.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.fu = new Bn(e), this.highestTargetId = e), t.sequenceNumber > this.lu && (this.lu = t.sequenceNumber);
    }, t.prototype.na = function(t, e) {
        return this.wu(e), this.targetCount += 1, Dn.resolve();
    }, t.prototype.ki = function(t, e) {
        return this.wu(e), Dn.resolve();
        ...
        return this._u.Hi(e, n), Dn.resolve();
        ...
        return this._u.Zi(e), Dn.resolve();
    }, t.prototype.Bi = function(t, e) {
        var n = this._u.er(e);
        return Dn.resolve(n);
    }, t.prototype.nr = function(t, e) {
        return Dn.resolve(this._u.nr(e));
    }, t;
}(), kr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Ru = {}, this.Au = new Sn(0), this.Pu = !1, this.Pu = !0, this.Li = t(this), 
        this.Ii = new Tr(this), this.kn = new jn, this.Nn = new Ar(this.kn, (function(t) {
            return e.Li.Vu(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Ru[t.rr()];
        return e || (e = new Nr(this.kn, this.Li), this.Ru[t.rr()] = e), e;
        ...
        return Dn.Fn(Object.values(this.Ru).map((function(n) {
            return function() {
                return n.nr(t, e);
            };
        })));
    ...
    return t.ku = function(e) {
        ...
        return this.Nu.zi(n, e), this.Ou.delete(n.toString()), Dn.resolve();
    }, t.prototype.Yi = function(t, e, n) {
        return this.Nu.Yi(n, e), this.Ou.add(n.toString()), Dn.resolve();
    }, t.prototype.Ja = function(t, e) {
        return this.Ou.add(e.toString()), Dn.resolve();
        ...
        // Remove newly orphaned documents.
                return Dn.forEach(this.Ou, (function(r) {
            var i = U.U(r);
        ...
        var n = this;
        return Dn.Fn([ function() {
            return Dn.resolve(n.Nu.nr(e));
        }, function() {
     ...
     * HTTP).
     */
    return t.__extends(n, e), n.prototype.Ju = function(t, e, n, r) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case i.ErrorCode.TIMEOUT:
                        h("Connection", 'RPC "' + t + '" timed out'), s(new R(k.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case i.ErrorCode.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new R(a, r.message));
                            } else s(new R(k.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        s(new R(k.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.Ku, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], o = i.createWebChannelTransport(), s = {
        ...
        var a = o.createWebChannel(u, s), c = !1, f = !1, p = new Lr({
            Lu: function(t) {
        ...
        return d(i.WebChannel.EventType.OPEN, (function() {
            ...
            f || (f = !0, h("Connection", "WebChannel transport closed"), p.Qu());
        })), d(i.WebChannel.EventType.ERROR, (function(t) {
            f || (f = !0, l("Connection", "WebChannel transport errored:", t), p.Qu(new R(k.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!f) {
                ...
                if (i) {
                    ...
                    f = !0, p.Qu(new R(s, u)), a.close();
                } else h("Connection", "WebChannel received:", n), p.ju(n);
            }
        })), setTimeout((function() {
    ...
    return e.prototype.initialize = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.qh = this.rc(e), this.persistence = this.oc(e), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return t.sent(), this.hc = this.ac(e), this.co = this.uc(e), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new Ir, r = t.cc, new Wn(e, n, r);
        var e, n, r;
    }, e.prototype.oc = function(t) {
        if (t._c.lc) throw new R(k.FAILED_PRECONDITION, qr);
        return new kr(Dr.ku);
        ...
        throw new R(k.FAILED_PRECONDITION, qr);
    }, e;
}(), Mr = /** @class */ function() {
    function e() {}
    return e.prototype.initialize = function(e, n) {
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.co ? [ 3 /*break*/ , 3 ] : (this.co = e.co, this.qh = e.qh, this.lo = this.fc(n), 
                  ...
                  case 1:
                    return t.sent(), [ 4 /*yield*/ , this.Mh.nh(this.qo.Zh) ];
        ...
        return new _r(this.qo);
    }, e.prototype.fc = function(t) {
        var e, n = Ur(t.Gu.s), r = (e = t.Gu, new Sr(e));
        /** Return the Platform-specific connectivity monitor. */ return function(t, e, n) {
            return new cr(t, e, n);
        }(t.credentials, r, n);
    }, e.prototype.dc = function(t) {
        var e = this;
        return new fr(this.co, this.lo, t.Rs, (function(t) {
 ...
 */ function jr(t, e) {
    if (0 !== e.length) throw new R(k.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function Gr(t, e, n) {
    if (e.length !== n) throw new R(k.INVALID_ARGUMENT, "Function " + t + "() requires " + oi(n, "argument") + ", but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function Br(t, e, n) {
    if (e.length < n) throw new R(k.INVALID_ARGUMENT, "Function " + t + "() requires at least " + oi(n, "argument") + ", but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function Wr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new R(k.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + oi(e.length, "argument") + ".");
}
...
function Hr(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = Jr(r);
        throw new R(k.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function Yr(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new R(k.INVALID_ARGUMENT, "Invalid value " + Jr(r) + " provided to function " + t + "() for its " + ii(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function Kr(t, e, n, r) {
    if (!("object" === e ? Zr(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = Jr(r);
        throw new R(k.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function ti(t, e, n) {
    if (void 0 === n) throw new R(k.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + ii(e) + " argument, but it was undefined.");
}
 ...
 */ function ei(t, e, n) {
    N(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new R(k.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function ni(t, e, n, r) {
    var i = Jr(r);
    return new R(k.INVALID_ARGUMENT, "Function " + t + "() requires its " + ii(n) + " argument to be a " + e + ", but it was: " + i);
}

function ri(t, e, n) {
    if (n <= 0) throw new R(k.INVALID_ARGUMENT, "Function " + t + "() requires its " + ii(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function si() {
    if ("undefined" == typeof Uint8Array) throw new R(k.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function ui() {
    if ("undefined" == typeof atob) throw new R(k.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var ai = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        Gr("Blob.fromBase64String", arguments, 1), zr("Blob.fromBase64String", "string", 1, e), 
        ui();
        try {
            return new t(B.fromBase64String(e));
        } catch (e) {
            throw new R(k.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
        if (Gr("Blob.fromUint8Array", arguments, 1), si(), !(e instanceof Uint8Array)) throw ni("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(B.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return Gr("Blob.toBase64", arguments, 0), ui(), this.Rc.toBase64();
    }, t.prototype.toUint8Array = function() {
        return Gr("Blob.toUint8Array", arguments, 0), si(), this.Rc.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new R(k.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + oi(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (zr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new R(k.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Ac = new O(t);
}, hi = /** @class */ function(e) {
    /**
    ...
    return t.__extends(n, e), n.prototype.yc = function(t) {
...
var yi = /** @class */ function(e) {
    ...
    return t.__extends(n, e), n.prototype.yc = function(t) {
        var e = new _e(t.serializer, $t(t.serializer, this.Cc));
    ...
    return t.__extends(n, e), n.delete = function() {
        return jr("FieldValue.delete", arguments), new bi(new pi("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return jr("FieldValue.serverTimestamp", arguments), new bi(new yi("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Br("FieldValue.arrayUnion", arguments, 1), new bi(new vi("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Br("FieldValue.arrayRemove", arguments, 1), new bi(new gi("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return zr("FieldValue.increment", "number", 1, t), Gr("FieldValue.increment", arguments, 1), 
...
}(wi), _i = /** @class */ function() {
    function t(t, e) {
        if (Gr("GeoPoint", arguments, 2), zr("GeoPoint", "number", 1, t), zr("GeoPoint", "number", 2, e), 
        !isFinite(t) || t < -90 || t > 90) throw new R(k.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new R(k.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Dc = t, this.Fc = e;
    }
     ...
     */
    t.prototype.m = function(t) {
        return w(this.Dc, t.Dc) || w(this.Fc, t.Fc);
    }, t;
}(), Ei = /^__.*__$/, Ii = function(t, e, n) {
    ...
    return t.prototype.Oc = function(t, e) {
        var n = [];
        return null !== this.qe ? n.push(new qe(t, this.data, this.qe, e)) : n.push(new Ue(t, this.data, e)), 
        this.fieldTransforms.length > 0 && n.push(new Me(t, this.fieldTransforms)), n;
    }, t;
}(), Ai = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.qe = e, this.fieldTransforms = n;
    ...
    return t.prototype.Oc = function(t, e) {
        ...
        return this.fieldTransforms.length > 0 && n.push(new Me(t, this.fieldTransforms)), 
        n;
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var ki = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Lc = function(e) {
        ...
        return xi(t, this.settings.methodName, this.settings.Wc || !1, this.path, this.settings.vc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Ti(this.pc) && Ei.test(t)) throw this.gc('Document fields cannot begin and end with "__"');
    }, t;
}(), Ri = /** @class */ function() {
    function t(t, e, n) {
        this.s = t, this.ignoreUndefinedProperties = e, this.serializer = n || Ur(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.Qc = function(t, e, n, r) {
        return void 0 === r && (r = !1), new ki({
            pc: t,
            methodName: e,
            vc: n,
            path: O.k(),
 ...
 * classes.
 */
/** Parse document data from a set() call. */ function Di(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Qc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    qi("Data must be an object, but it was:", s, r);
    var u, a, c = Oi(r, s);
    if (o.merge) u = new Ne(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var p = l[f], y = void 0;
            if (p instanceof ci) y = p.Ac; else {
                if ("string" != typeof p) throw d();
                y = Mi(e, p, n);
            }
            if (!s.contains(y)) throw new R(k.INVALID_ARGUMENT, "Field '" + y + "' is specified in your field mask but missing from your input data.");
            Fi(h, y) || h.push(y);
        }
        u = new Ne(h), a = s.fieldTransforms.filter((function(t) {
            return u.je(t.field);
        }));
    } else u = null, a = s.fieldTransforms;
    return new Ni(new Be(c), u, a);
}
...
/** Parse update data from an update() call. */ function Li(t, e, n, r) {
    ...
    var o = [], s = new We;
    N(r, (function(t, r) {
        var u = Mi(e, t, n), a = i.Uc(u);
        if (r instanceof li && r.Pc instanceof pi) 
    ...
    var u = new Ne(o);
    return new Ai(s.ze(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Vi(t, e, n, r, i, o) {
    var s = t.Qc(1 /* Update */ , e, n), u = [ Ci(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new R(k.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) u.push(Ci(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new We, l = u.length - 1; l >= 0; --l) if (!Fi(h, u[l])) {
        var p = u[l], d = a[l], y = s.Uc(p);
        if (d instanceof li && d.Pc instanceof pi) 
        // Add it to the field mask, but don't add anything to updateData.
        h.push(p); else {
            var v = Pi(d, y);
    ...
    var g = new Ne(h);
    return new Ai(f.ze(), g, s.fieldTransforms);
}
 ...
 */ function Si(t, e, n, r) {
    return void 0 === r && (r = !1), Pi(n, t.Qc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Pi(t, e) {
    if (Ui(t)) return qi("Unsupported field value:", e, t), Oi(t, e);
    if (t instanceof li) 
    ...
    return function(t, e) {
        ...
        if (!Ti(e.pc)) throw e.gc(t.Vc + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof Ii) {
            ...
            return {
                referenceValue: Kt(t.Nc || e.s, t.$c.path)
            };
        }
...
function Ui(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof D || t instanceof _i || t instanceof ai || t instanceof Ii || t instanceof li);
}
 ...
 */ function Ci(t, e, n) {
    if (e instanceof ci) return e.Ac;
 ...
 */ function Mi(e, n, r) {
    try {
        return function(e) {
            if (e.search(fi) >= 0) throw new R(k.INVALID_ARGUMENT, "Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (hi.bind.apply(hi, t.__spreadArrays([ void 0 ], e.split("."))));
            } catch (t) {
                throw new R(k.INVALID_ARGUMENT, "Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(n).Ac;
    } catch (n) {
        throw xi((i = n) instanceof Error ? i.message : i.toString(), e, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
    /**
...
function xi(t, e, n, r, i) {
    ...
    a += ")"), new R(k.INVALID_ARGUMENT, (u += ". ") + t + a);
}
 ...
 */ var ji = /** @class */ function() {
    ...
    return e.prototype.Hc = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var n, r = this;
            return t.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.Yc(), this.mutations.length > 0) throw new R(k.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(e, n) {
                        return t.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return t.__generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return r = v(e), i = ee(r.serializer) + "/documents", o = {
                                        documents: n.map((function(t) {
                                            return Zt(r.serializer, t);
                                        }))
                                    ...
                                    return s = t.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Jt(t, e.found.name), r = Yt(e.found.updateTime), i = new Be({
                                                    mapValue: {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((n = i.sent()).forEach((function(t) {
                        t instanceof Xe || t instanceof Qe ? r.Jc(t) : d();
                    })), n) ];
                }
            }));
        }));
                ...
                switch (r.label) {
                  case 0:
                    ...
                    e.forEach((function(t, e) {
                        var r = U.U(e);
                        n.mutations.push(new Ge(r, n.We(r)));
        ...
        var e;
        if (t instanceof Qe) e = t.version; else {
            if (!(t instanceof Xe)) throw d();
        ...
        if (n) {
            ...
            throw new R(k.ABORTED, "Document version changed between two reads.");
    ...
    e.prototype.We = function(t) {
        ...
        return !this.zc.has(t.toString()) && e ? ke.updateTime(e) : ke.Ge();
    }, 
    /**
    ...
    e.prototype.Xc = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new R(k.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function e(t, e, n, r) {
        this.Rs = t, this.lo = e, this.updateFunction = n, this.Vs = r, this.Zc = 5, this.ks = new On(this.Rs, "transaction_retry" /* TransactionRetry */)
    ...
    return e.prototype.run = function() {
        ...
        this.ks.ws((function() {
            return t.__awaiter(e, void 0, void 0, (function() {
                var e, n, r = this;
                return t.__generator(this, (function(t) {
                    return e = new ji(this.lo), (n = this.el(e)) && n.then((function(t) {
                        r.Rs.vs((function() {
     ...
     */
    e) {
        this.credentials = t, this.Rs = e, this.clientId = m.t(), 
    ...
    return e.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.lr((function(t) {
            if (!s) return s = !0, h("FirestoreClient", "Initializing. user=", t.uid), i.ol(e, n, r, t, o).then(i.il.resolve, i.il.reject);
            i.Rs.Bs((function() {
                return i.Mh.eh(t);
            }));
        })), 
     ...
     *     succeeded.
     */
    e.prototype.ol = function(e, n, r, i, o) {
        return t.__awaiter(this, void 0, void 0, (function() {
            var s, u, a = this;
            return t.__generator(this, (function(c) {
                switch (c.label) {
                  ...
                  case 2:
                    return c.sent(), this.persistence = e.persistence, this.qh = e.qh, this.co = e.co, 
                    this.hc = e.hc, this.lo = n.lo, this.Mh = n.Mh, this.qo = n.qo, this.hl = n.mc, 
    ...
    e.prototype.rl = function() {
        if (this.Rs.xs) throw new R(k.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
            ...
            return t.__awaiter(e, void 0, void 0, (function() {
                ...
                return t.__generator(this, (function(t) {
                    switch (t.label) {
                      ...
                      case 1:
                        return t.sent(), [ 4 /*yield*/ , this.qh.Oo() ];
                      ...
                      case 4:
                        return e = t.sent(), r = xn(e, "Failed to shutdown persistence"), n.reject(r), [ 3 /*break*/ , 5 ];
                    ...
                    return [ 2 /*return*/ , (n.sent(), function(e, n, r) {
                        return t.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return t.__generator(this, (function(s) {
                                switch (s.label) {
                                  case 0:
                                    return i = new Pn, [ 4 /*yield*/ , e.enqueue((function() {
                                        return t.__awaiter(o, void 0, void 0, (function() {
                                            ...
                                            return t.__generator(this, (function(t) {
                                                switch (t.label) {
                                                  ...
                                                  case 1:
                                                    return (e = t.sent()) instanceof Qe ? i.resolve(e) : e instanceof Xe ? i.resolve(null) : i.reject(new R(k.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];

                                                  case 2:
                                                    return o = t.sent(), s = xn(o, "Failed to get document '" + r + " from cache"), 
                ...
                switch (t.label) {
                  ...
                  case 1:
                    return [ 2 /*return*/ , (t.sent(), function(t, e, n, r) {
                        var i = new Pn, o = Wi(t, e, Ze(n.path), {
                                    ...
                                    return i = new Pn, [ 4 /*yield*/ , e.enqueue((function() {
                                        return t.__awaiter(o, void 0, void 0, (function() {
                                            ...
                                            return t.__generator(this, (function(t) {
                                                switch (t.label) {
                                                  case 0:
                                                    return t.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , Yn(n, r, 
                                                    /* usePreviousResults= */ !0) ];

                                                  case 1:
                                                    return e = t.sent(), o = new vr(r, e.Wi), s = o.gh(e.documents), u = o.Ch(s, 
                                                    /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                                  case 2:
                                                    return a = t.sent(), c = xn(a, "Failed to execute query '" + r + " against cache"), 
                    ...
                    return [ 2 /*return*/ , (t.sent(), function(t, e, n, r) {
                        var i = new Pn, o = Wi(t, e, n, {
                            ...
                            next: function(t) {
                                // Remove query first before passing event to user to avoid
                                // user actions affecting the now stale query.
                                o(), t.fromCache && r && "server" === r.source ? i.reject(new R(k.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
    ...
    }, Object.defineProperty(e.prototype, "fl", {
        get: function() {
    ...
    e.prototype.transaction = function(t) {
        ...
        var n = new Pn;
        return this.Rs.vs((function() {
            return new Gi(e.Rs, e.lo, t, n).run(), Promise.resolve();
        })), n.promise;
    }, e;
}();
...
var zi = /** @class */ function() {
    ...
    return t.prototype.ml = function(t) {
        ...
        return new _i(Pt(t.latitude), Pt(t.longitude));
        ...
        var e = S.$(t);
        y(fe(e));
        var n = new E(e.get(1), e.get(3)), r = new U(e.p(5));
...
}(), $i = Fn.ni, Qi = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new R(k.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Qr("settings", "non-empty string", "host", t.host), this.host = t.host, Xr("settings", "boolean", "ssl", t.ssl), 
        ...
        Xr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Fn.ii; else {
            if (t.cacheSizeBytes !== $i && t.cacheSizeBytes < Fn.si) throw new R(k.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Fn.si);
    ...
    function e(n, r, i, o) {
        var s = this;
        if (void 0 === i && (i = new Cr), void 0 === o && (o = new Mr), this.Vl = i, this.yl = o, 
        this.pl = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.gl = new Mn, this.INTERNAL = {
            delete: function() {
                return t.__awaiter(s, void 0, void 0, (function() {
                    return t.__generator(this, (function(t) {
                        switch (t.label) {
            ...
            var u = n;
            this.pl = u, this.Nc = e.Sl(u), this.Cl = u.name, this.Dl = new rr(r);
        } else {
            var a = n;
            if (!a.projectId) throw new R(k.INVALID_ARGUMENT, "Must provide projectId");
            this.Nc = new E(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Cl = "[DEFAULT]", this.Dl = new nr;
        }
        this.Fl = new Qi({});
    }
    return Object.defineProperty(e.prototype, "Nl", {
        get: function() {
            return this.$l || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.$l = new Ri(this.Nc, this.Fl.ignoreUndefinedProperties)), this.$l;
        },
        enumerable: !1,
        configurable: !0
    }), e.prototype.settings = function(t) {
        Gr("Firestore.settings", arguments, 1), zr("Firestore.settings", "object", 1, t), 
        t.merge && 
        // Remove the property from the settings once the merge is completed
        delete (t = Object.assign(Object.assign({}, this.Fl), t)).merge;
        var e = new Qi(t);
        if (this.bl && !this.Fl.isEqual(e)) throw new R(k.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.Fl = e, void 0 !== e.credentials && (this.Dl = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new R(k.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
        ...
        var e, n;
        if (this.bl) throw new R(k.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new R(k.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            var e, n = this;
            return t.__generator(this, (function(r) {
                if (void 0 !== this.bl && !this.bl.fl) throw new R(k.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return e = new Pn, [ 2 /*return*/ , (this.gl.Ls((function() {
                    return t.__awaiter(n, void 0, void 0, (function() {
                        var n;
                        return t.__generator(this, (function(t) {
                            switch (t.label) {
                              case 0:
                                return t.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Vl.clearPersistence(this.Nc, this.Cl) ];
    ...
    }, Object.defineProperty(e.prototype, "Ll", {
        get: function() {
        ...
        if (this.vl(), xr(t)) return this.bl.Fa(t);
        ...
        return new _(this.Nc, this.Cl, this.Fl.host, this.Fl.ssl, this.Fl.experimentalForceLongPolling);
    }, e.prototype.Ol = function(t, e, n) {
        var r = this.Ml();
        return this.bl = new Bi(this.Dl, this.gl), this.bl.start(r, t, e, n);
    }, e.Sl = function(t) {
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new R(k.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */        if (!n || "string" != typeof n) throw new R(k.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new E(n);
    }, Object.defineProperty(e.prototype, "app", {
        get: function() {
            if (!this.pl) throw new R(k.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.pl;
        },
        enumerable: !1,
        configurable: !0
    }), e.prototype.collection = function(t) {
        return Gr("Firestore.collection", arguments, 1), zr("Firestore.collection", "non-empty string", 1, t), 
        this.vl(), new co(S.$(t), this, 
        /* converter= */ null);
    }, e.prototype.doc = function(t) {
        return Gr("Firestore.doc", arguments, 1), zr("Firestore.doc", "non-empty string", 1, t), 
        this.vl(), Ki.ql(S.$(t), this, 
        /* converter= */ null);
    }, e.prototype.collectionGroup = function(t) {
        if (Gr("Firestore.collectionGroup", arguments, 1), zr("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new R(k.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.vl(), new uo(function(t) {
            return new Ke(S.k(), t);
        }(t), this, 
        /* converter= */ null);
    }, e.prototype.runTransaction = function(t) {
        var e = this;
        return Gr("Firestore.runTransaction", arguments, 1), zr("Firestore.runTransaction", "function", 1, t), 
        this.vl().transaction((function(n) {
            return t(new Hi(e, n));
        }));
    }, e.prototype.batch = function() {
        return this.vl(), new Yi(this);
        ...
        var e;
        Gr("Firestore.setLogLevel", arguments, 1), Yr("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, a.setLogLevel(e);
    }, 
    ...
    return t.prototype.get = function(t) {
        var e = this;
        Gr("Transaction.get", arguments, 1);
        var n = po("Transaction.get", t, this.Wl);
        return this.Ql.Hc([ n.$c ]).then((function(t) {
            if (!t || 1 !== t.length) return d();
            var r = t[0];
            if (r instanceof Xe) return new Ji(e.Wl, n.$c, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.kc);
            if (r instanceof Qe) return new Ji(e.Wl, n.$c, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.kc);
            throw d();
        }));
        ...
        var r = po("Transaction.set", t, this.Wl);
        n = ho("Transaction.set", n);
        var i = vo(r.kc, e, n), o = Di(this.Wl.Nl, "Transaction.set", r.$c, i, null !== r.kc, n);
        return this.Ql.set(r.$c, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof hi ? (Br("Transaction.update", arguments, 3), 
        r = po("Transaction.update", t, this.Wl), i = Vi(this.Wl.Nl, "Transaction.update", r.$c, e, n, o)) : (Gr("Transaction.update", arguments, 2), 
        r = po("Transaction.update", t, this.Wl), i = Li(this.Wl.Nl, "Transaction.update", r.$c, e)), 
        this.Ql.update(r.$c, i), this;
    }, t.prototype.delete = function(t) {
        Gr("Transaction.delete", arguments, 1);
        var e = po("Transaction.delete", t, this.Wl);
    ...
    return t.prototype.set = function(t, e, n) {
        Wr("WriteBatch.set", arguments, 2, 3), this.Kl();
        var r = po("WriteBatch.set", t, this.Wl);
        n = ho("WriteBatch.set", n);
        var i = vo(r.kc, e, n), o = Di(this.Wl.Nl, "WriteBatch.set", r.$c, i, null !== r.kc, n);
        return this.jl = this.jl.concat(o.Oc(r.$c, ke.Ge())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Kl(), "string" == typeof e || e instanceof hi ? (Br("WriteBatch.update", arguments, 3), 
        r = po("WriteBatch.update", t, this.Wl), i = Vi(this.Wl.Nl, "WriteBatch.update", r.$c, e, n, o)) : (Gr("WriteBatch.update", arguments, 2), 
        r = po("WriteBatch.update", t, this.Wl), i = Li(this.Wl.Nl, "WriteBatch.update", r.$c, e)), 
        this.jl = this.jl.concat(i.Oc(r.$c, ke.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        Gr("WriteBatch.delete", arguments, 1), this.Kl();
        var e = po("WriteBatch.delete", t, this.Wl);
        return this.jl = this.jl.concat(new je(e.$c, ke.Ge())), this;
    }, t.prototype.commit = function() {
        return this.Kl(), this.Gl = !0, this.jl.length > 0 ? this.Wl.vl().write(this.jl) : Promise.resolve();
    }, t.prototype.Kl = function() {
        if (this.Gl) throw new R(k.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Ki = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t.__extends(n, e), n.ql = function(t, e, r) {
        if (t.length % 2 != 0) throw new R(k.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.N() + " has " + t.length);
        ...
        get: function() {
            return new co(this.$c.path.g(), this.firestore, this.kc);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (Gr("DocumentReference.collection", arguments, 1), zr("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new R(k.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = S.$(t);
        return new co(this.$c.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        ...
        Wr("DocumentReference.set", arguments, 1, 2), e = ho("DocumentReference.set", e);
        var n = vo(this.kc, t, e), r = Di(this.firestore.Nl, "DocumentReference.set", this.$c, n, null !== this.kc, e);
        return this.bl.write(r.Oc(this.$c, ke.Ge()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof hi ? (Br("DocumentReference.update", arguments, 2), 
        n = Vi(this.firestore.Nl, "DocumentReference.update", this.$c, t, e, r)) : (Gr("DocumentReference.update", arguments, 1), 
        n = Li(this.firestore.Nl, "DocumentReference.update", this.$c, t)), this.bl.write(n.Oc(this.$c, ke.exists(!0)));
    }, n.prototype.delete = function() {
        return Gr("DocumentReference.delete", arguments, 0), this.bl.write([ new je(this.$c, ke.Ge()) ]);
        ...
        "object" != typeof i[u] || xr(i[u]) || (ei("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        } else zr("DocumentReference.onSnapshot", "function", u, i[u]), $r("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        ...
        return this.bl.listen(Ze(this.$c.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        Wr("DocumentReference.get", arguments, 0, 1), lo("DocumentReference.get", t);
        var n = this.firestore.vl();
        return t && "cache" === t.source ? n.ul(this.$c).then((function(t) {
            return new Ji(e.firestore, e.$c, t, 
            /*fromCache=*/ !0, t instanceof Qe && t.Ke, e.kc);
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (Wr("DocumentSnapshot.data", arguments, 0, 1), t = fo("DocumentSnapshot.data", t), 
        this.Hl) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.kc) {
                var n = new to(this.Wl, this.$c, this.Hl, this.Yl, this.Jl, 
                /* converter= */ null);
                return this.kc.fromFirestore(n, t);
            }
            return new zi(this.Wl.Nc, this.Wl.Ul(), t.serverTimestamps || "none", (function(t) {
                return new Ki(t, e.Wl, /* converter= */ null);
            })).ml(this.Hl.tn());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (Wr("DocumentSnapshot.get", arguments, 1, 2), e = fo("DocumentSnapshot.get", e), 
        this.Hl) {
            var r = this.Hl.data().field(Ci("DocumentSnapshot.get", t, this.$c));
            if (null !== r) return new zi(this.Wl.Nc, this.Wl.Ul(), e.serverTimestamps || "none", (function(t) {
                return new Ki(t, n.Wl, n.kc);
            })).ml(r);
        }
        ...
        get: function() {
            return new Ki(this.$c, this.Wl, this.kc);
        },
        enumerable: !1,
        configurable: !0
